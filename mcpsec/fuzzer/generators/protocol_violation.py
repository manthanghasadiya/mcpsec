...
def generate() -> list[FuzzCase]:
    ...
    cases.append(FuzzCase(
        ...
        payload=_frame({"jsonrpc": "1.0", "method": "tools/list", "id": 1}),
    ...
    cases.append(FuzzCase(
        ...
        generator="protocol_violation",
        payload=_frame({"method": "tools/list", "id": 1}),
    ...
    cases.append(FuzzCase(
        ...
        generator="protocol_violation",
        payload=_frame(init_msg),  # Second init after normal init
    ...
    cases.append(FuzzCase(
        name="unknown_method",
        generator="protocol_violation",
        payload=_frame({"jsonrpc": "2.0", "method": "hacker/pwn", "id": 1}),
    ...
    cases.append(FuzzCase(
        ...
        generator="protocol_violation",
        payload=_frame({"jsonrpc": "2.0", "method": "tools/list", "id": 99999999999999999999}),
    ...
    cases.append(FuzzCase(
        name="string_id",
        generator="protocol_violation",
        payload=_frame({"jsonrpc": "2.0", "method": "tools/list", "id": "test-string-id"}),
    ...
    cases.append(FuzzCase(
        ...
        generator="protocol_violation",
        payload=_frame({"jsonrpc": "2.0", "method": "tools/list"}),
