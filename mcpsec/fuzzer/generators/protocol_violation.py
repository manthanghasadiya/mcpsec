...
def generate(framing: str = "clrf") -> list[FuzzCase]:
    ...
    cases.append(
        FuzzCase(
            ...
            generator="protocol_violation",
            payload=_frame(
                {"jsonrpc": "2.0", "method": "tools/list", "id": 99999999999999999999}, framing
            ),
    ...
    cases.append(
        FuzzCase(
            ...
            generator="protocol_violation",
            payload=_frame(
                {"jsonrpc": "2.0", "method": "tools/list", "id": "test-string-id"}, framing
            ),
    ...
    cases.append(
        FuzzCase(
            ...
            generator="protocol_violation",
            payload=_frame(
                {"jsonrpc": "2.0", "method": "tools/call", "id": 1, "params": {}}, framing
            ),
